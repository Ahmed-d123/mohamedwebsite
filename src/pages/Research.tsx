    ...
    <div className="min-h-screen px-6 py-24 bg-gradient-to-br from-gray-900/50 to-black">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          <div className="bg-black p-8 rounded-lg border border-white/20 hover:border-white transition-all duration-300 shadow-xl">
        ...
        <div className="mt-12 bg-gray-900 p-8 rounded-lg border border-white/20">
