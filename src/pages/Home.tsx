    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        <div className="max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed mb-12">
      ...
      <section id="achievements" className="min-h-screen px-6 py-24 bg-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-lg border border-black/20 hover:border-black transition-all duration-300 hover:transform hover:-translate-y-2 shadow-xl">
          ...
          <div className="bg-white p-8 rounded-lg border border-black/20">
      ...
      <section id="projects" className="min-h-screen px-6 py-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-black p-8 rounded-lg border border-white/30 hover:border-white transition-all duration-300 shadow-xl">
      ...
      <section id="research" className="min-h-screen px-6 py-24 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 mb-12">
            <div className="bg-black p-8 rounded-lg border border-white/30 transition-all duration-300 shadow-xl">
          ...
          <div className="bg-black p-8 rounded-lg border border-white/30">
            <h3 className="text-2xl font-bold text-white mb-4">Research Approach</h3>
            <p className="text-gray-300 leading-relaxed">
