    ...
    <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 text-white">
      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        <div className="max-w-4xl text-center">
          <div className="mb-6">
            <Atom className="w-16 h-16 text-white mx-auto mb-4 animate-pulse" />
          </div>
          ...
          <button
            onClick={() => scrollToSection('about')}
            className="px-8 py-3 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-all duration-300 shadow-lg"
          >
            Explore Portfolio
          </button>
        </div>
      ...
      <section id="about" className="min-h-screen px-6 py-24 bg-gradient-to-br from-gray-900/50 to-black">
      ...
      <section id="achievements" className="min-h-screen px-6 py-24 bg-gradient-to-br from-black to-gray-900/50">
      ...
      <section id="leadership" className="min-h-screen px-6 py-24 bg-gradient-to-br from-gray-900/50 to-black">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-bold mb-16 text-center">
            <span className="text-white">03.</span> Leadership & Mentorship
          </h2>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-black p-8 rounded-lg border border-white/20 shadow-xl hover:border-white transition-all duration-300">
          ...
          <div className="bg-gray-900 p-8 rounded-lg border border-white/20">
            <h3 className="text-2xl font-bold text-white mb-4">Impact & Vision</h3>
            <p className="text-gray-400 leading-relaxed">
      ...
      <section id="projects" className="min-h-screen px-6 py-24 bg-gradient-to-br from-black to-gray-900/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-bold mb-16 text-center">
          ...
          <div className="bg-black/50 p-8 rounded-lg border border-white/20">
            <h3 className="text-2xl font-bold text-white mb-4">Project Philosophy</h3>
            <p className="text-gray-400 leading-relaxed">
      ...
      <section id="research" className="min-h-screen px-6 py-24 bg-gradient-to-br from-gray-900/50 to-black">
