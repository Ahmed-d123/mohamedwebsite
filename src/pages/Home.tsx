import { ChevronDown, Award, Briefcase, Users, Code, BookOpen, Mail, Linkedin, Download } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <section id="about" data-animate className="min-h-screen px-6 py-24 flex items-center bg-white opacity-0">
      ...
      <section id="achievements" data-animate className="min-h-screen px-6 py-24 flex items-center bg-gray-50 opacity-0">
        <div className="max-w-4xl mx-auto w-full">
      ...
      <section id="paid-work" data-animate className="min-h-screen px-6 py-24 flex items-center bg-white opacity-0">
        <div className="max-w-4xl mx-auto w-full">
      ...
      <section id="activities" data-animate className="min-h-screen px-6 py-24 flex items-center bg-gray-50 opacity-0">
        <div className="max-w-4xl mx-auto w-full">
      ...
      <section id="projects" data-animate className="min-h-screen px-6 py-24 flex items-center bg-white opacity-0">
        <div className="max-w-4xl mx-auto w-full">
      ...
      <section id="research" data-animate className="min-h-screen px-6 py-24 flex items-center bg-gray-50 opacity-0">
        <div className="max-w-4xl mx-auto w-full">
